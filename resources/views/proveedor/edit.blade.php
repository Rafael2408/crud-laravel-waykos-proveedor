...
@section('content')
    <div class="container" style="max-width: 600px;">
        ...
        <form method="POST" action="{{ route('proveedor.update', $proveedor->prov_id) }}" class="form-horizontal">
            @csrf
            @method('PUT')
